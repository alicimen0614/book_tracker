      ...
      builder: (context) {
        return Column(mainAxisSize: MainAxisSize.min, children: [
          if (quote.isbnData!=null || quote.isbnData!="") ListTile(
            ...
            onTap: () async {
              bool isBookAlreadyExists = await checkIfBookAlreadyExists(quote.isbnData,ref.read(bookStateProvider).listOfBooksFromFirestore,ref.read(bookStateProvider).listOfBooksFromSql,ref);
          ...
          if (FirebaseAuth.instance.currentUser != null &&
            ...
            visualDensity: const VisualDensity(vertical: 3),
            onTap: () async {
              showDialog(context: context, builder: (context) => DeleteDialog(quoteId: quoteId),);
            },
            leading: const Icon(
              Icons.delete,
              size: 30,
          ...
          ListTile(
            visualDensity: const VisualDensity(vertical: 3),
            onTap: () async {
               showDialog(context: context, builder: (context) =>  ReportingDialog(quoteEntry:QuoteEntry(id: quoteId, quote: quote)),);
            },
            leading: const Icon(
              Icons.report_sharp,
              size: 30,
